...
class Match(models.Model):
    home_team = models.ForeignKey(Team, verbose_name=_('Home team'),
                                  related_name='home_team', on_delete=models.CASCADE)
    visiting_team = models.ForeignKey(Team, verbose_name=_('Visiting team'),
                                      related_name='visiting_team', on_delete=models.CASCADE)
    ...
    league = models.ForeignKey(League, verbose_name=_('League'), on_delete=models.CASCADE)
